...
public class NavAgentMovement : MonoBehaviour
{
    ...
    private bool _isControllerMode = false; // 현재 네브메시 모드인지 컨트롤러 모드인지 확인
    private float _knockBackStartTime;
    private Action EndKnockBackAction; // 넉백이 끝나고 실행해야 할 콜백이 있다면 여기다 저장 후 실행
    ...
    private bool CalculateKnockBack()
    {
        ...
        float ratio = spendTime / _knockBackSpeed;
